...
def opportunity_artifact_slug(opportunity: Opportunity | str) -> str:
    """Return the normalized folder slug for an opportunity artifact set."""

    opportunity_id = opportunity.id if isinstance(opportunity, Opportunity) else opportunity
    return slugify(opportunity_id)
